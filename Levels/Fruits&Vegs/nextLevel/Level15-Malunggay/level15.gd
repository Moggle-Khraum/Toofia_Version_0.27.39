...
func _on_retry_pressed() -> void:
	var retry = get_tree().change_scene("res://Levels/Fruits&Vegs/nextLevel/Level16-Guyabano/level16.tscn")
	print('Retry level')

func _on_nextQuestion_pressed() -> void:
	ScrollPop.play()
	yield(get_tree().create_timer(0.12), "timeout")
	var retry = get_tree().change_scene("res://Levels/Fruits&Vegs/nextLevel/Level17-Durian/level13.tscn")
