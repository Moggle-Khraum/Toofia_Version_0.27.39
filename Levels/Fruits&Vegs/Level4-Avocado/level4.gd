...
func _on_retry_pressed() -> void:
	var retry = get_tree().change_scene("res://Levels/Fruits&Vegs/Level4-Avocado/level4.tscn")
	print('Retry level')

func _on_nextQuestion_pressed() -> void:
	ScrollPop.play()
	yield(get_tree().create_timer(0.12), "timeout")
	var nextQ = get_tree().change_scene("res://Levels/Fruits&Vegs/Level5-Grapes/level5.tscn")
