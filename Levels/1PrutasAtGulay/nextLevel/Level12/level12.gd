...
func _on_x_pressed():
	$"%infoCorn".stream_paused = false
	print("Info Corn Plays")
...
func _on_pauseButton_pressed():
	...
	$"%infoCorn".stream_paused = true
	print("Info Corn Stop")
...
func _on_repeat_pressed():
	...
	if not $"%infoCorn".playing or $"%askVoice12".playing or $"%choiceA".playing or $"%choiceB".playing or $"%choiceC".playing or $"%pickAnswer".playing:
		$"%coverButton".show()
		print("Cover Show")
	else:
		$"%coverButton".hide()
...
func _on_retry_pressed() -> void:
	var retry = get_tree().change_scene("res://Levels/1PrutasAtGulay/nextLevel/Level12/level12.tscn")
	print('Retry level')
