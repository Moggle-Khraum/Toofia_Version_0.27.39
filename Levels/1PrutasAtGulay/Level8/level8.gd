...
func voiceOver():
	...
	if $"%infoPinya".playing:
		$"%coverButton".show()


func _on_x_pressed():
	$"%infoPinya".stream_paused = false
	print("Info Pinya Plays")
...
func _on_pauseButton_pressed():
	...
	$"%infoPinya".stream_paused = true
	print("Info Pinya Stop")
...
func _on_repeat_pressed():
	...
	if not $"%infoPinya".playing or $"%askVoice8".playing or $"%choiceA".playing or $"%choiceB".playing or $"%choiceC".playing or $"%pickAnswer".playing:
		$"%coverButton".show()
		print("Cover Show")
	else:
		$"%coverButton".hide()
